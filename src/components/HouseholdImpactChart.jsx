...
function HouseholdImpactChart({ selectedPolicy }) {
  ...
  const getSelectedLabel = (type) => {
    switch (type) {
      ...
      case 'filing':
        return filingStatus === 'single' ? 'Single' : filingStatus === 'head' ? 'Head of household' : 'Married'
      case 'children':
        return children === '0' ? 'No children' : children === '1' ? '1 child' : children === '2' ? '2 children' : '3+ children'
      case 'deduction':
    ...
    <div className="household-impact-chart">
      ...
      <div className="household-chart-container">
        <div className="chart-labels-top">
          <span className="label-italic">Each dot represents one household</span>
        </div>
        ...
        <ResponsiveContainer width="100%" height={700}>
          <ScatterChart margin={{ top: 20, right: 80, left: 40, bottom: 60 }}>
            ...
            <XAxis
              ...
              dataKey="x"
              domain={[-10000, 10000]}
              ticks={[-10000, -8000, -6000, -4000, -2000, 0, 2000, 4000, 6000, 8000, 10000]}
            ...
            <YAxis
              ...
              scale="log"
              domain={[10000, 500000]}
              ticks={[10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000, 200000, 300000, 400000, 500000]}
              tickFormatter={(value) => {
        ...
        <div className="chart-labels-bottom">
          <div className="label-container">
            <span className="label-left">← Households receiving tax increases</span>
      ...
      <div className="household-questions-expandable">
        ...
        <div className="expandable-question">
          ...
          >
            ...
            <span className="toggle-icon">{expandedQuestion === 'income' ? '−' : '+'}</span>
          </button>
          {expandedQuestion === 'income' && (
            <div className="question-content">
              <p className="question-help">
                Make your best guess at your adjusted gross income (A.G.I.). Include wage and salary income as well as taxable income from investments, rental properties, business ventures and other sources.
              </p>
        ...
        <div className="expandable-question">
          ...
          >
            ...
            <span className="toggle-icon">{expandedQuestion === 'filing' ? '−' : '+'}</span>
          </button>
        ...
        <div className="expandable-question">
          ...
          >
            <span className="question-title">Do you have children under age 17 living at home?</span>
            <span className="selected-value">{getSelectedLabel('children')}</span>
            <span className="toggle-icon">{expandedQuestion === 'children' ? '−' : '+'}</span>
          </button>
          {expandedQuestion === 'children' && (
            <div className="question-content">
              <p className="question-help">
                New provisions like the expanded child tax credit would lead to a bigger tax cut for many families.
              </p>
              <div className="button-grid compact">
                <button
        ...
        <div className="expandable-question">
          ...
          >
            <span className="question-title">Did you take the standard deduction this year?</span>
            <span className="selected-value">{getSelectedLabel('deduction')}</span>
            <span className="toggle-icon">{expandedQuestion === 'deduction' ? '−' : '+'}</span>
          </button>
          {expandedQuestion === 'deduction' && (
            <div className="question-content">
              <p className="question-help">
                The bill nearly doubles the standard deduction to £12,000 for individuals and £24,000 for families. Most people already take the standard deduction, but the expansion would lead more people to do so.
              </p>
              <div className="button-grid compact">
                <button
        ...
        <div className="expandable-question">
          ...
          >
            <span className="question-title">Do you live in a high-tax area?</span>
            <span className="selected-value">{getSelectedLabel('tax')}</span>
            <span className="toggle-icon">{expandedQuestion === 'tax' ? '−' : '+'}</span>
          </button>
          {expandedQuestion === 'tax' && (
            <div className="question-content">
              <p className="question-help">
                High-tax areas include London, South East England, and other regions with higher local taxes. The plan may affect these areas differently than others.
              </p>
              <div className="button-grid compact">
                <button
