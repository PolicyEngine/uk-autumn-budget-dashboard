  ...
  useEffect(() => {
    ...
    fetch('/data/reform-results.csv')
      ...
      .then(csvText => {
        ...
        console.log('[FiscalHeadroom] All budgetary_impact rows:', budgetaryRows)

        if (impact2029 === null) {
          console.error('[FiscalHeadroom] No 2029 budgetary impact found')
          console.error('[FiscalHeadroom] Available years:', budgetaryRows.map(r => r.year))
          setLoading(false)
          return
        }
        ...
        console.log('Headroom calculation:', { obrHeadroom, impact2029, newHeadroom })
    ...
    <div className="fiscal-headroom">
      ...
      <div className="headroom-container">
        <div className="headroom-item">
          ...
          <div className="headroom-value baseline">{formatBillion(headroom.obr)}</div>
        </div>
        ...
        <div className="headroom-item">
          ...
          <div className={`headroom-value ${headroom.impact < 0 ? 'negative' : 'positive'}`}>
            {headroom.impact < 0 ? '−' : '+'}{formatBillion(headroom.impact)}
          </div>
        </div>
        ...
        <div className="headroom-item result">
          ...
          <div className={`headroom-value ${headroom.new < headroom.obr ? 'decreased' : 'increased'}`}>
